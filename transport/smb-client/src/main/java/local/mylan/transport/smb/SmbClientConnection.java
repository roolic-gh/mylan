...
import local.mylan.transport.smb.handler.Smb2ClientHandler;
import local.mylan.transport.smb.handler.codec.NtlmCodecUtils;
import local.mylan.transport.smb.protocol.Flags;
import local.mylan.transport.smb.protocol.details.Connection;
...
import local.mylan.transport.smb.protocol.flows.NtlmAuthMechanism;
import local.mylan.transport.smb.protocol.smb2.Smb2CapabilitiesFlags;
import local.mylan.transport.smb.protocol.smb2.Smb2NegotiateFlags;

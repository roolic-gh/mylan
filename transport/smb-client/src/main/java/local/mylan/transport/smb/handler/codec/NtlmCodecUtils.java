...
import local.mylan.transport.smb.protocol.spnego.ntlm.NtChallengeResponse;
...
import local.mylan.transport.smb.protocol.spnego.ntlm.NtlmAvId;
...
import local.mylan.transport.smb.protocol.spnego.ntlm.NtlmMessageType;
...
import local.mylan.transport.smb.protocol.spnego.ntlm.NtlmSingleHostData;
...
import local.mylan.transport.smb.protocol.spnego.ntlm.NtlmVersion;

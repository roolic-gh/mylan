...
/**
 * Connection Oriented Bind PDU. Addresses C706 PCE 1.1 (#12.6.4.3 The bind PDU).
 */
public class PceBind extends PceMessage {

    private int maxTransmitFragmentSize;
    private int maxReceiveFragmentSize;
    private int assocGroupId;
    private List<PduDataTypes.ContextElement> contexts;

    public PceBind(final int callId) {
        super(callId);
    }

    public PceBind(final PduDataTypes.Version pduVersion, final Flags<PduDataTypes.PfcFlags> pfcFlags,
    ...
    public List<PduDataTypes.ContextElement> contexts() {
        return contexts;
    }

    public void setContexts(final List<PduDataTypes.ContextElement> contexts) {
